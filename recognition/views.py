...
def add_photos(request):
	...
	if request.method=='POST':
		...
		if username_present(username):
			...
			messages.success(request, f'Dataset Created, Your Face Captured Successfully!')
...
def view_attendance_home(request):
	total_num_of_student=total_number_students()
	student_present_today=students_present_today()
	this_week_student_count_vs_date()
	last_week_student_count_vs_date()
	return render(request,"recognition/view_attendance_home.html", {'total_num_of_student' : total_num_of_student, 'student_present_today': student_present_today})
